...
export default function Home() {
  ...
  const [numberOfWhitelised, setNumberOfWhitelisted] = useState(0);
      ...
      if (joinedWhitelist) {
        return (
          <div className={styles.description}>
            Thanks for joining the Whitelist you sexy beast!
          </div>
        );
      } else if (loading) {
        return (
          <button className={styles.button}>
            Loading...Keep yer pants on, jeez
          </button>
        );
      } else {
        return (
